"""
Django settings for inventorylocator_38717 project.
...
ROOT_URLCONF = 'inventorylocator_38717.urls'
...
WSGI_APPLICATION = 'inventorylocator_38717.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "inventorylocator_38717 API",
    "DESCRIPTION": "API documentation for inventorylocator_38717 App",
    "VERSION": "v1",
}
